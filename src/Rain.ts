...
export class Rain {
  ...
  async getTrendingTags(params: TrendingTagsParams) {
  ...
  async getUserPositions(params: UserPositionsParams, accessToken: string) {
    return investmentsApi.getUserPositions(params, this.cfg(accessToken));
  }
  ...
  async getUserSharePositions(params: UserSharePositionsParams, accessToken: string) {
    return investmentsApi.getUserSharePositions(params, this.cfg(accessToken));
  }
  ...
  async toggleBookmark(params: ToggleBookmarkParams, accessToken: string) {
    return bookmarksApi.toggleBookmark(params, this.cfg(accessToken));
  }

  async getBookmarks(params: GetBookmarksParams, accessToken: string) {
    return bookmarksApi.getBookmarks(params, this.cfg(accessToken));
  }
